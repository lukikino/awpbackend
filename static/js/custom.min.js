var initJqueryPlugin = function () {
    ...
    $(window).ready(i), $(window).on("resize", i), $(".sidebartoggler").on("click", function () {
        ...
        $(".fix-header .header").length && $(".fix-header .header").stick_in_parent({}), $(".nav-toggler").click(function () {
        ...
        $("#sidebarnav").length && $(function () {
            $("#sidebarnav").metisMenu();
        }),

        $(".scroll-sidebar").length && $(".scroll-sidebar").slimScroll({
            position: "left",
            size: "5px",
            height: "100%",
            color: "#dcdcdc"
        ...
        $(".message-center").length && $(".message-center").slimScroll({
            position: "right",
            size: "5px",
            color: "#dcdcdc"
        }),

        $(".aboutscroll").length && $(".aboutscroll").slimScroll({
            position: "right",
            size: "5px",
            height: "80",
            color: "#dcdcdc"
        ...
        $(".message-scroll").length &&$(".message-scroll").slimScroll({
            position: "right",
            size: "5px",
            height: "570",
            color: "#dcdcdc"
        ...
        $(".chat-box").length &&$(".chat-box").slimScroll({
            position: "right",
            size: "5px",
            height: "470",
            color: "#dcdcdc"
        ...
        $(".slimscrollright").length && $(".slimscrollright").slimScroll({
            height: "100%",
            position: "right",
            size: "5px",
            color: "#dcdcdc"
